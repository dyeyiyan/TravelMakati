...
public class PopularSpotAdapter extends RecyclerView.Adapter<PopularSpotAdapter.MyHolder> {

    Context context;
    List<LeisureModel> leisureList;
    private DatabaseReference leisureRef,  mostViewRef;
//    private DatabaseReference totalRef; //reference of posts
//    private DatabaseReference recentViewedRef;
//    private DatabaseReference leisureRef;
    String myUID;


    public PopularSpotAdapter(Context context, List<LeisureModel> leisureList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PopularSpotAdapter.MyHolder(view);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            ivPhoto = itemView.findViewById(R.id.rpi_iv_leisure_photo);
