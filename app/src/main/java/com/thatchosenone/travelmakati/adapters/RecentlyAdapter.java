...
public class RecentlyAdapter extends RecyclerView.Adapter <RecentlyAdapter.MyHolder>{
    ...
    public RecentlyAdapter(Context context, List<LeisureModel> leisureList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecentlyAdapter.MyHolder(view); // return holder
    }
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        try {
            Picasso.get().load(lphoto).into(holder.ivLeisure);
        } catch (Exception e) {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            ivLeisure = itemView.findViewById(R.id.rpi_iv_leisure);
