...
public class RecommendedAdapter extends RecyclerView.Adapter <RecommendedAdapter.MyHolder>{
    ...
    public RecommendedAdapter(Context context, List<LeisureModel> leisureList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecommendedAdapter.MyHolder(view); // return holder
    }
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            ivLeisure = itemView.findViewById(R.id.rfpi_iv_leisure_photo);
