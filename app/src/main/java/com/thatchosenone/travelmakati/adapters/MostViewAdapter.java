...
public class MostViewAdapter extends RecyclerView.Adapter<MostViewAdapter.MyHolder>{
    ...
    public MostViewAdapter(Context context, List<LeisureModel> leisureList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MostViewAdapter.MyHolder(view);
    }
